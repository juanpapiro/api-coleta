...
public class ResponseFindDto {
	...
	public ResponseFindDto() {}
	
	public ResponseFindDto(Page<Object> page) {
		super();
	...
	public ResponseFindDto(List<Object> listResponse, int number, int size, int totalElements) {
		super();
	...
	public void setResponse(List<Object> products) {
